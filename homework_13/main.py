...
def process_file(fn, device_memc, dry_run, max_workers=8):
    processed = 0
    errors = 0
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        for line in lines:
            ...
            if not memc_addr:
                ...
                continue
            futures.append(executor.submit(insert_appsinstalled, memc_addr, appsinstalled, dry_run))
        ...
        for future in as_completed(futures):
            try:
                ...
                logging.exception("Exception in memc insert: %s" % e)
                errors += 1
